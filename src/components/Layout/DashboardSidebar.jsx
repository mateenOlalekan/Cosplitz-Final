...
import { Home, Share2, MessageSquare, Wallet, MapPin, BarChart3, PieChart, Users, ShieldCheck, Mail } from "lucide-react";
...
export default function Sidebar({ sidebarOpen, isMobile, setSidebarOpen }) {
  ...
  const adminOnly = [
    { icon: ADMIN_ICONS.Overview, label: "Overview", url: "/admin/overview", count: null },
  ...
  return (
    <aside className={`w-68 bg-white border-r border-gray-200 flex flex-col ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-50 transition-transform duration-300`}>
