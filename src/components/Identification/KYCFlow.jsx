...
// export default KYCFlow;
// Example KYC component showing how to complete the entire registration flow
import { useState } from 'react';
import { useNavigate } from 'react-router-dom';
...
export default function KYCFlow() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // const response = await submitKYCData(formDataToSend);
      
      // 🟢 Mark entire registration flow as complete
      await completeKYC.mutateAsync();
      
      console.log('🎉 KYC completed! User can now access full dashboard');
      
      // 🟢 Navigate to dashboard - user now has full access
      navigate('/dashboard', { replace: true });
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-[#F7F5F9] flex items-center justify-center p-4">
