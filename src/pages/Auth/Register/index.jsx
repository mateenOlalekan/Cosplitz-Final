...
export default function Register() {
    ...
    useEffect(() => {
        console.log("[DEBUG] User check for step transition:", {
            user,
            currentStep,
        });
    ...
    const handleRegister = async (formData) => {
        ...
        try {
            ...
            if (res.success) {
                ...
                const errorMsg =
                    res.error || res.data?.message || "Registration failed";
    ...
    const handleVerifyOTP = async (otp) => {
        ...
        try {
            ...
            if (res.success) {
                ...
                const errorMsg =
                    res.error || res.data?.message || "OTP verification failed";
                    ...
                    <div className="w-full flex flex-col items-center">
                        ...
                        <div className="bg-gradient-to-br max-w-lg from-[#FAF3E8] to-[#F8EACD] mt-4 p-4 rounded-2xl shadow-sm text-center">
                            ...
                            <p className="text-xl font-medium text-[#4B4B4B] leading-relaxed">
                                Connect with students, travelers, and locals to
                                effortlessly manage costs and resources.
                            </p>
                        </div>
                    </div>
                </div>
