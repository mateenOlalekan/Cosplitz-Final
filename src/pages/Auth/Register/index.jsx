// src/pages/Register/index.jsx  (FULL Register.jsx – drop-in)
...
export default function Register() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    /* full Zod validation happens inside RegistrationForm – we only need to submit */
    const payload = {
      ...
      <div className="flex max-w-screen-2xl w-full h-full rounded-xl overflow-hidden">
        ...
        <div className="flex flex-1 flex-col items-center p-3 sm:p-5 overflow-y-auto">
          ...
          <div className="w-full max-w-2xl p-5 rounded-xl shadow-none md:shadow-md border-none md:border border-gray-100 bg-white">
            ...
            {/* STEP CONTENT */}
            {currentStep === 1 && <RegistrationForm formData={formData} 
            handleInputChange={handleInputChange} handleFormSubmit={handleFormSubmit} handleSocialRegister={handleSocialRegister} loading={storeLoading} error={storeError} />}
