...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      useAuthStore.getState().setError("An unexpected error occurred");
    } finally {
  ...
  const handleSocialLogin = (provider) => {
    ...
    useAuthStore.getState().setError(`${provider} login is coming soon!`);
  };
    ...
    <PublicRoute>
      <div className="flex bg-[#F7F5F9] w-full min-h-screen justify-center items-center md:px-6 md:py-4 rounded-2xl">
        <div className="flex max-w-screen-2xl w-full h-full rounded-xl overflow-hidden">
          ...
          {/* Right Side (Form) */}
          <div className="flex flex-1 flex-col items-center justify-center p-3 sm:p-6 overflow-y-auto">
            <div className="w-full max-w-md">
              ...
              {/* Login Card */}
              <div className="w-full p-6 md:p-8 rounded-xl shadow-md border border-gray-100 bg-white">
